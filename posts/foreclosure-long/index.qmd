...
![Actual vs. Predicted Resolution Times for Current Model](actual%20vs.png)
...
![Random Forest Model Predictions vs Actual Resolution Times](rf%20pred.png)
...
![Feature Importance for Random Forest Model](rf%20importance.png)
...
![Random Forest Model Predictions vs Actual Resolution Times](rf%20pred.png) This plot helps us visualize how well our predictions match the actual values. Points closer to the red line indicate better predictions.
